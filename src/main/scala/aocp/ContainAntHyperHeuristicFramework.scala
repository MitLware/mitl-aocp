...
object ContainAntHyperHeuristicFramework {
   ...
   */
  def run[T:scala.reflect.runtime.universe.TypeTag](
    heuristic: Heuristic,
    instance: Module,
    maximizing: T => Double
   ...
   */   
  def experimentN[T:scala.reflect.runtime.universe.TypeTag](
    heuristics: Seq[Heuristic],
    runs: Int,
    instance: Module,
    maximizing: T => Double
  ...
  def experiment[T:scala.reflect.runtime.universe.TypeTag](
